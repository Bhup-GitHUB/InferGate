...
export async function createKey(key: string, scopes: string[], expiresInDays?: number, tier?: string): Promise<{ id: string; prefix: string; api_key: string; scopes: string[] }> {
